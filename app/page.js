    ...
    >
      ...
      <div className="pt-5 pl-10 pr-5 bg-white rounded-md shadow-sm sm:w-full lg:w-[440px]  h-auto flex flex-col ">
        ...
        <form className="mt-6 mb-10">
          <div className="flex items-center border-b border-[#1D4851] py-2">
            <label htmlFor="email" className="mr-2 text-[#1D4851]">
              <FaEnvelope />
            </label>
            <input
              type="email"
          ...
          <div className=" flex items-center border-b border-[#1D4851] py-2">
            <label htmlFor="password" className="mr-2 text-[#1D4851]">
              <FaLock />
            </label>
            <input
              type="password"
          ...
          <button
            ...
            disabled={disable}
            onClick={handleLogin}
            className="mt-6 bg-[#1D4851] hover:bg-[#008080] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline float-rigth"
          >
            Se Connecter{" "}
            {loading && (
              <svg
        ...
        <div className="mb-10 text-center text-sm font-bold">
          No account yet?{" "}
          <span className="hover:text-[#1D4851]">
